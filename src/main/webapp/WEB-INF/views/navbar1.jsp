...
<div class="container-fluid p-3">
    <div class="row">
        ...
        <c:if test="${not empty userObj }">
            <div class="col-md-3">
                <a href="<c:url value='/checkout'/>" class="btn btn-danger"><i class="fa-solid fa-cart-shopping"></i> Cart</a>
                <a href="#" class="btn btn-success "><i class="fa-solid fa-user-plus"></i> ${userObj.name }</a>
                <a href="<c:url value='/logout'/>" class="btn btn-primary text-white"><i class="fa-solid fa-arrow-right-to-bracket"></i> Logout</a>
            </div>
        </c:if>
        <c:if test="${empty userObj }">
            <div class="col-md-3">
                <a href="<c:url value='/loginPage'/>" class="btn btn-success"><i class="fa-solid fa-arrow-right-to-bracket"></i> Login</a>
                <a href="<c:url value='/registerPage'/>" class="btn btn-primary text-white"><i class="fa-solid fa-user-plus"></i> Register</a>
            </div>
        </c:if>
    </div>
</div>
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active"><a class="nav-link" href="<c:url value='/index'/>">Home
                    <span class="sr-only">(current)</span>
                </a></li>
            <li class="nav-item active"><a class="nav-link" href="<c:url value='/all_new_book'/>"><i class="fa-solid fa-book-open"></i> New Book</a></li>
            <li class="nav-item active"><a class="nav-link disabled" href="<c:url value='/all_old_book'/>"><i class="fa-solid fa-book-open"></i> Old Book</a></li>
        </ul>
        <form class="form-inline my-2 my-lg-0">
            <a href="<c:url value='/setting'/>" class="btn btn-Light my-2 my-sm-0 text-white" type="submit"><i class="fa-solid fa-gears"></i> Setting</a>
            <a href="<c:url value='/help-center'/>" class="btn btn-Light my-2 my-sm-0 ml-1 text-white"><i class="fa-solid fa-square-phone"></i> Contact Us</a>
        </form>
    </div>
</nav>
